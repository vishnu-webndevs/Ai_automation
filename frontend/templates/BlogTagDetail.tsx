...
const BlogTagDetail: React.FC<{ initialData?: any }> = ({ initialData }) => {
    ...
    const faqs = [
        {
            question: `What articles are included in the #${tag.name} tag?`,
            answer: `In this section, we cover various topics and guides relating to #${tag.name}.`
        },
        {
            question: `Why choose Totan AI's insights on #${tag.name}?`,
            answer: `Totan AI provides expert, production-grade guidelines and case studies on #${tag.name} and AI-driven business automation.`
        }
    ];
